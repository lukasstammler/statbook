...
* Bei linkssteilen Verteilungen hat der Median einen negativen $z$-Wert.   
* Bei rechtssteilen Verteilungen hat der Median einen postiven $z$-Wert. 
...
kennen gelernt: Sie lassen sich durch Form (symmetrisch, links- oder rechtssteil, 
irregulär), Kennzahlen der zentralen Tendenz und Kennzahlen der Streuung beschreiben.   

*Beachte, dass Histogramme, Boxplots, Punktediagramme die Verteilung von 
...
In der statistischen Schreibweise wird die Wahrscheinlichkeit für ein Ereignis 
$X$ geschrieben als
...
Der $z$-Wert für den 85g Apfel ist negativ da er leichter ist als ein durchschnittlicher Apfel. Um wie viel leichter? Um -1.5 Standardabweichungen = 15g. Der $z$-Wert für den 110g-Apfel ist positiv, d.h. er ist schwerer als ein durchschnittlicher Apfel. Um wie viel schwerer? Um 1 Standardabweichung = 10g.  

### Interpretation von z-Werten 

Uns interessiert die Frage: Wie wahrscheinlich ist es, dass ein Apfel 85g schwer oder leichter ist? 
...
- Aktuelle Statistikprogramme verwenden, unabhängig vom Stichprobenumfang, als Testsstatistik $t$-Werte anstelle von  $z$-Werten.  
